...
module.exports = function (config) {
    var myView, _myDiv, _myMap, _myGmapLayer, _myGmapLayers, _myStyle, _myHoverListenerSet, _myHoverListenerReset, _myOnClickListener, _mySelectedFeatures, _mySelectionLimit, _mySelectionCount, _myFeatureId;
    _myDiv = document.getElementById(config.div);

    fetchGoogleGeocode(config.address, function (_myAddress) {
        viewGmap_Map(_myAddress, _myDiv, config.styles, config.options, function (myBasemap) {
            viewGmap_Labels(myBasemap, config.labelStyles, function (myLabelledMap) {
                _myMap = myLabelledMap;
                myView = {};
                myView.map = _myMap;
            ...
            Object.defineProperty(myView, 'newGmapLayer', {
                get: function () { return _myGmapLayers; },
                set: function (name, id, url) {
                    if (!_myGmapLayers) {
                        _myGmapLayers = {};
                    }
                    if (myView[name] && id === "DELETE") {
                        delete(_myGmapLayers[name]);
                        delete(myView[name]);
                    } else if (!myView[name] && id !== "DELETE") {
                        _myGmapLayer = new google.maps.Data();
                        _myGmapLayer.loadGeoJson(url, {idPropertyName: id});
                        Object.defineProperty(myView.map, name, {
                            value: _myGmapLayer
                        });
                        Object.defineProperty(myView[name], 'style', {
                        ...
                        Object.defineProperty(myView[name], 'on', {
                            value: function () { _myGmapLayer.setMap(_myDiv); }
                        });
                        Object.defineProperty(myView[name], 'off', {
                            value: function () { _myGmapLayer.setMap(null); }
                        });
                        Object.defineProperty(myView[name], 'onHover', {
                        ...
                        Object.defineProperty(myView[name], 'onClick', {
